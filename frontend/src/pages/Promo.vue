    ...
    <div class="promotions">
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>party Order upto 20% off</h3>
                <ul>
                    <li>
                        <p>Order more than 2000 will get discount 20%</p>
                    </li>
                    <li>
                        <p>Only weekend night</p>
                    </li>
                    <li>
                        <p>Valid for online order </p>
                    </li>
                </ul>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>Farmhouse and bonfire party upto 25% extra</h3>
                <ul>
                    <li>
                        <p>party night with unlimited delicious food </p>
                    </li>
                    <li>
                        <p>offer for student and office employee </p>
                    </li>
                    <li>
                        <p>Book Your event on Call  </p>
                    </li>
                </ul>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
        ...
        <div class="promotions-item">
            ...
            <div class="description">
                <h3>Grab unlimited Stater on Christmas   </h3>
                <ul>
                    <li>
                        <p> Unlimited Starter at just 249 veg & 349 Non-Veg per- Person </p>
                    </li>
                    <li>
                        <p>Lucky 10 Person Will Get 100% Discount.</p>
                    </li>
                    <li>
                        <p>From 24/12/2022 to 25/12/2022</p>
                    </li>
                </ul>
                <router-link @click="scrollToTop()" to="/menu" class="btn">order now</router-link>
            </div>
